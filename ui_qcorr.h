...
public:
    ...
    void setupUi(QMainWindow *QcorrClass)
    {
        ...
        action_Map = new QAction(QcorrClass);
        action_Map->setObjectName(QString::fromUtf8("action_Map"));
        action_Map->setCheckable(true);
        ...
        actionTemplate_Matching->setEnabled(false);
        ...
        action_Disparity_Finder->setEnabled(false);
        ...
        menu_View->addAction(action_Map);
    ...
    void retranslateUi(QMainWindow *QcorrClass)
    {
        ...
        action_Map->setText(QApplication::translate("QcorrClass", "&Map", 0, QApplication::UnicodeUTF8));
