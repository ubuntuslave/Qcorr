...
class ImgLabel : public QLabel
{
   ...
   private:
      ...
      bool m_bHasRubberBand;  ///< indicates whether the rubberBand instance exist.
       ...
       */
      void setTemplateFlags(bool bStatus);
      ...
      /** @brief Displays the XY-coordinates of the mouse pointer (relative to the ImgLabel) in the status bar of the friend-parent's main window
   ...
   protected:
       void mousePressEvent(QMouseEvent *event);   ///< press mouse event handler
       void mouseMoveEvent(QMouseEvent *event); ///< move mouse event handler
       void mouseReleaseEvent(QMouseEvent *event); ///< release mouse event handler
};
